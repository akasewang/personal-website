...
export async function generateMetadata({ params }: PageProps) {
  ...
  return {
    ...
    openGraph: {
      ...
      publishedTime,
      type: "article",
      url: `https://www.akasewang.me/blog/${post.slug}`,
      images: [
        {
          url: `https://www.akasewang.me/og/blog?title=${post.metadata.title}`,
        },
      ],
    },
    twitter: {
      ...
      creator: "@akasewang",
      images: [
        `https://www.akasewang.me/og/blog?title=${post.metadata.title}&top=${publishedTime}`,
      ],
    },
  }
}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: post.metadata.description,
            image: `https://akasewang.me/og/blog?title=${
              post.metadata.title
            }&top=${formatDate(post.metadata.date)}`,
            url: `https://akasewang.me/blog/${post.slug}`,
            author: {
              "@type": "Person",
              name: "akash dewangan",
            },
